...
**< 참전한 사람과 참전하지 않은 사람의 평균을 단순 계산했을 경우 >**
...
#### Step1. never-taker, always-taker, complier 각각의 비중을 구해보자.
...
- compllier
    - lottery 비선발(0) 되어서 전쟁 참전하지 않은 사람의 평균임금 :
        - (0.6888 * *5.4028 + 0.1237* X) / (0.6888+0.1237) = **5.6948**
    - lottery 선발되어서(1) 전쟁 참전한 사람의 평균 임금 :
        - (*0.1874* * *5.4076 + 0.1237*X) / (*0.1874*+*0.1237*) = **5.4612**
